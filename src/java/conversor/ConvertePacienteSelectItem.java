 ...
 * @author Adelino
 */
@FacesConverter(value = "conversorPaciente")
public class ConvertePacienteSelectItem implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
        try {
            SelectItem selectedItem = this.getSelectedItemByIndex(uic, Integer.parseInt(string));
